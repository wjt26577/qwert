...
RButton & 2::       !mouse_edge() ? CycAct.slow("show_thishotkey")               : CycAct.slow("url_yunwu", "url_lovart", "url_claude", "url_chatgpt", "url_gemini", "url_copilot", "do_nothing")
RButton & 3::       !mouse_edge() ? CycAct.slow("show_thishotkey")               : CycAct.slow("app_qianwen", "url_deepseek", "app_doubao", "url_coze", "url_kimi", "do_nothing")
RButton & 4::       !mouse_edge() ? CycAct.slow("show_thishotkey")               : CycAct.slow("app_qianwen", "url_deepseek", "do_nothing")
RButton & q::       !mouse_edge() ? CycAct.slow("show_thishotkey")               : CycAct.slow("url_zhyw", "url_zhlmt", "url_wjx", "do_nothing")
RButton & w::       !mouse_edge() ? CycAct.slow("{Escape}")                      : CycAct.slow("app_wechat", "app_wxwork", "app_wemeet", "do_nothing")
RButton & e::       !mouse_edge() ? CycAct.slow("^{WheelUp}")                    : CycAct.slow("app_everything", "app_evernote", "app_eagle", "do_nothing")
RButton & r::       !mouse_edge() ? CycAct.slow("^z")                            : CycAct.slow("app_powerpoint", "app_eagle", "app_evernote", "do_nothing")
RButton & t::       !mouse_edge() ? CycAct.slow("^y")                            : CycAct.slow("app_typora")
RButton & a::       !mouse_edge() ? CycAct.slow("show_thishotkey")               : CycAct.slow("app_cherrystudio")
RButton & s::       !mouse_edge() ? CycAct.slow("+#{Left}")                      : CycAct.slow("app_vscode", "app_spy", "file_shortcut", "url_ahk_help", "url_ahk_forum", "do_nothing")
RButton & d::       !mouse_edge() ? CycAct.slow("^{WheelDown}")                  : CycAct.slow("open_current_path", "open_recycle_bin", "open_duty_schedule", "do_nothing")
RButton & f::       !mouse_edge() ? CycAct.slow("show_thishotkey")               : CycAct.slow("app_notepad", "app_excel", "app_baidu", "do_nothing")
RButton & g::       !mouse_edge() ? CycAct.slow("paste_format")                  : CycAct.slow("url_jd", "url_xianyu", "url_taobao", "do_nothing")
RButton & z::       !mouse_edge() ? CycAct.slow("show_thishotkey")               : CycAct.slow("app_powershell", "app_powershell_admin", "app_powershell_terminal", "app_cmd", "do_nothing")
RButton & x::       !mouse_edge() ? CycAct.slow("show_thishotkey")               : CycAct.slow("app_word", "app_mailmaster", "app_youdaodict", "do_nothing")
RButton & c::       !mouse_edge() ? CycAct.slow("show_thishotkey")               : CycAct.slow("close_window_in_taskbar")
RButton & v::       !mouse_edge() ? CycAct.slow("show_thishotkey")               : CycAct.slow("url_bilibili", "url_qqlive", "url_xiaohongshu", "url_iqiyi", "url_douyin", "do_nothing")
RButton & b::       !mouse_edge() ? CycAct.slow("show_thishotkey")               : CycAct.slow("path_pbb_server", "path_wh_server", "path_gr_server", "do_nothing")
RButton & Esc::     !mouse_edge() ? CycAct.slow("show_thishotkey")               : CycAct.slow("show_thishotkey")
RButton & RShift::  !mouse_edge() ? CycAct.slow("show_thishotkey")               : CycAct.slow("show_thishotkey")
RButton & Ctrl::    !mouse_edge() ? CycAct.slow("show_thishotkey")               : CycAct.slow("show_thishotkey")
RButton & Space::   !mouse_edge() ? CycAct.slow("show_thishotkey")               : CycAct.slow("show_thishotkey")
